...
export default function TipJarButton() {
  ...
  const modal = (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-ink-900/50 px-4 py-8"
      onClick={() => setOpen(false)}
    >
      <div
        className="my-auto w-full max-w-sm rounded-2xl bg-cream-50 p-6 shadow-xl"
